    ...
    <div className="border-b border-neutral-800 pb-24">
      ...
      <div className="flex flex-wrap gap-4 justify-center items-center">
        <motion.div
          ...
          transition={{ duration: 1.5 }}
          className="flex flex-wra[ items-center justify-center gap-4"
        >
          <motion.div
          ...
          <motion.div
            ...
            className="rounded-2xl border-4 border-neutral-800 p-4"
          >
            <IoLogoJavascript className="text-7xl text-yellow-500"></IoLogoJavascript>
          </motion.div>
          ...
          <motion.div
            ...
            className="rounded-2xl border-4 border-neutral-800 p-4"
          >
            <FaJava className="text-7xl text-red-500"></FaJava>
          </motion.div>
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <FaCss3Alt className="text-7xl text-blue-500"></FaCss3Alt>
        </motion.div>
      </div>
    </div>
  );
